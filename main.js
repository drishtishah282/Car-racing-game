...
function my_keydown(e) {
  ...
  if(car1_x>700)
  {
    console.log("Purple Car Has Won!!!");
    document.getElementById('game_status').innerHTML="Purple Car Has Won!!!";
  }
  if(car2_x>700)
  {
    console.log("Pink Car Has Won!!!");
    document.getElementById('game_status').innerHTML="Pink Car Has Won!!!";
  }
}
function car1_up() {
  if (car1_y >= 0) {
